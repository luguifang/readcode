...
ngx_int_t        ngx_process_slot; /*当前操作的进程在ngx_process 数组中的下标*/
...
/*ngx_spawn_process 封装了fork系统调用
参数 proc:子进程中将要执行的工作循环
*/
ngx_pid_t
    ...
    char *name, ngx_int_t respawn)
{
    ...
    if (respawn != NGX_PROCESS_DETACHED) {
		...
		/*通过socketpair 系统调用产生用于 父子进程同学的套接字对-----lgf6.3*/

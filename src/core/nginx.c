...
/*
不重启服务升级nginx的操作老的nginx进程通过环境变量"NGINX"来传递需要打开的监听端口
新的nginx进程通过ngx_add_inherited_sockets 方法来使用已经打开的tcp监听端口
*/
...
/*
cycle:分配的ngx_cycle_t 结构体
function: 用运行nginx可能携带的目录参数来初始化cycle
*/
